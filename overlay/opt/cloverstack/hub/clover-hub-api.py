...
CLOVERSTACK_MODULES = {
    "netmon":         {"name": "NetMon",          "desc": "Network monitoring (Zabbix)",
                       "port": 8080, "category": "CloverStack Core", "icon": "satellite"},
    ...
    "chappie":        {"name": "Chappie AI",      "desc": "AI assistant (Ollama + Open WebUI)",
                       "port": 3003, "category": "CloverStack Core", "icon": "brain"},
    "chatbox-team":   {"name": "Chatbox Team",    "desc": "Shared AI API proxy",
                       "port": 3010, "category": "CloverStack Core", "icon": "message-square"},
    "anythingllm":    {"name": "AnythingLLM",     "desc": "AI chat + document workspaces",
                       "port": 3001, "category": "CloverStack Core", "icon": "file-text"},
    ...
    "cloversign":     {"name": "CloverSign",      "desc": "Digital signage",
                       "port": 8097, "category": "CloverStack Core", "icon": "monitor"},
    "cloverguard":    {"name": "CloverGuard",     "desc": "Web proxy + content filter",
                       "port": 3128, "category": "CloverStack Core", "icon": "shield"},
    "clovermine":     {"name": "CloverMine",      "desc": "Crypto mining",
                       "port": 8098, "category": "CloverStack Core", "icon": "cpu"},
    "cloverpos":      {"name": "CloverPOS",       "desc": "Point of sale",
                       "port": 8099, "category": "CloverStack Core", "icon": "credit-card"},
    "cloverdesign":   {"name": "CloverDesign",    "desc": "AI design studio",
                       "port": 8100, "category": "CloverStack Core", "icon": "pen-tool"},
    "cloverbot":      {"name": "CloverBot",       "desc": "AI support chatbot (LibreChat)",
                       "port": 3080, "category": "CloverStack Core", "icon": "bot"},
    "cloverdrone":    {"name": "CloverDrone",     "desc": "UAV control",
                       "port": 8101, "category": "CloverStack Core", "icon": "navigation"},
    "streamserver":   {"name": "StreamServer",    "desc": "Live streaming platform",
                       "port": 1935, "category": "CloverStack Core", "icon": "video",
                       "extra_ports": {"HLS": 8088}},
}
